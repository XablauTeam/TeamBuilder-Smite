...
public class SmiteAPI
{
	...
	private long getTierConquest(String json) throws ConnectionException
	{
		...
		{
			throw new ConnectionException("Campo level é privado " + json.toString());
		}
		return tier;
	}
	...
	private String getName(String json) throws ConnectionException
	{
		...
		{
			throw new ConnectionException("Campo name é privado " + json.toString());
		}
		return name;
	}
	...
	private long getId(String json) throws ConnectionException
	{
		...
		{
			throw new ConnectionException("Campo id e privado" + json.toString());
		}
		return id;
	}
	...
	private String getMD5(String input) throws ConnectionException
	{
		...
		{
			throw new ConnectionException("Não foi possivel gerar a signature" + e.getMessage());
		}
	}
